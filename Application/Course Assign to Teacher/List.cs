...
namespace Application.Course_Assign_to_Teacher
{
    public class List
    {
        public class Query : IRequest<List<CourseAssignDto>> { }
        public class Handler : IRequestHandler<Query, List<CourseAssignDto>>
        {
            ...
            public async Task<List<CourseAssignDto>> Handle(Query request, CancellationToken cancellationToken)
            {
                //my code goes here

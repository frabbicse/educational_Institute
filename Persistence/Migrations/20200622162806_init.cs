        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignationId = table.Column<int>(nullable: false),
                    DepartmentId = table.Column<int>(nullable: false),
                    CreditTaken = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllocateRooms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AllocateRooms_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AllocateRooms_Days_DayId",
                        column: x => x.DayId,
                        principalTable: "Days",
                        principalColumn: "DayId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AllocateRooms_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AllocateRooms_Rooms_RoomId",
                        column: x => x.RoomId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AssignCourses_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "DepartmentId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AssignCourses_Teachers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentsResults_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentsResults_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "GradeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentsResults_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AllocateRooms_CourseId",
                table: "AllocateRooms",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_AllocateRooms_DayId",
                table: "AllocateRooms",
                column: "DayId");

            migrationBuilder.CreateIndex(
                name: "IX_AllocateRooms_DepartmentId",
                table: "AllocateRooms",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AllocateRooms_RoomId",
                table: "AllocateRooms",
                column: "RoomId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssignCourses_DepartmentId",
                table: "AssignCourses",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_AssignCourses_TeacherId",
                table: "AssignCourses",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentsResults_CourseId",
                table: "StudentsResults",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentsResults_GradeId",
                table: "StudentsResults",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentsResults_StudentId",
                table: "StudentsResults",
                column: "StudentId");
